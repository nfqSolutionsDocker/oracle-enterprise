...
/u01/oracle/oraInventory/orainstRoot.sh | while read line; do echo_command2 "orainstRoot.sh: $line"; done
/u01/oracle/app/product/11.2.0/dbhome_1/root.sh | while read line; do echo_command2 "root.sh: $line"; done